        ...
        <div className="relative" ref={emailModalRef}>
          ...
          {showEmailModal && (
            <div className="absolute left-14 bottom-0 z-40">
              <div className="bg-content p-xs rounded-lg shadow-md flex items-center gap-xs w-60">
                <span className="text-xs text-muted-foreground truncate flex-grow">
                  {user?.email || "Not logged in"}
                </span>

                <button
                  className="text-muted-foreground hover:text-foreground rounded-full hover:bg-hover relative p-1"
                ...
                >
                  ...
                  {showInfoMessage && (
                    <motion.div
                      className="absolute left-0 bottom-full mb-2 bg-content text-popover-foreground px-2 py-1 rounded text-xs shadow-md z-10 w-40"
              ...
              <div className="bg-content rounded-lg shadow-md p-xs">
                <div className="flex flex-col gap-xs w-32">
                  <button
                    ...
                    className={`flex items-center gap-xs p-1 rounded hover:bg-hover ${theme === "light" ? "text-foreground font-medium" : "text-muted-foreground"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-xs p-1 rounded hover:bg-hover ${theme === "dark" ? "text-foreground font-medium" : "text-muted-foreground"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-xs p-1 rounded hover:bg-hover ${theme === "system" ? "text-foreground font-medium" : "text-muted-foreground"
                      }`}
                  >
